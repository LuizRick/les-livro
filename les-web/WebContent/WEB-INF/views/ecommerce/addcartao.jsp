                ...
                <form action="adicionarCartao" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="numero" class="form-control" 
                        	data-mask="9999-9999-9999-9999" required/>
                    </div>
                    <div class="form-group">
                        <label>Baindeira</label>
                        <input type="text" name="bandeira" class="form-control" required/>
                    </div>
                    <div class="form-group">
                        <label>Codigo de segurança</label>
                        <input type="text" name="codigo" class="form-control" maxlength="3" required/>
                    </div>
                    <div class="form-group">
